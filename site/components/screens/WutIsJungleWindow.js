            ...
            <div 
                ...
                >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        <p>In order to earn these prizes, open the Jungle app and start foraging! You'll receive a fruit every 5-10 minutes which will automatically be converted to tokens. After you defeat your first boss, you can redeem your tokens up until that point and get assets for your game to make it to the next boss!</p>
