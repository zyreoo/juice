...
export default function RegisterWindow({
  ...
  const handleSubmit = async () => {
    if (
      !email ||
      email === "nevergonna@giveyouup.com" ||
      !email.match(/^[^\s@]+@[^\s@]+\.[^\s@]+$/)
    ) {
    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: 4,
          backgroundImage:
            "linear-gradient(white, white), linear-gradient(to right, #f79533, #f37055, #ef4e7b, #a166ab, #5073b8, #1098ad, #07b39b, #6fba82, #f79533)",
      ...
      >
        <style jsx>{`
          ...
          @keyframes pixelCrumble {
            ...
            70% {
              ...
              transform: translate(
                ...
                scale(0.7) rotate(-8deg) translateY(-20px);
              opacity: 0.5;
            ...
            100% {
              ...
              transform: translate(
                ...
                scale(0.4) rotate(12deg) translateY(-40px);
              opacity: 0;
              filter: brightness(2);
            }
          }
          ...
          .pixel-crumble {
            animation: pixelCrumble 1.2s cubic-bezier(0.22, 0.68, 0, 0.97)
              forwards !important;
        ...
        >
          {!showTokenUpload ? (
            <>
              <p>
                <i>Adventure Calls...</i> signing up means joining our team and
                committing to making your game.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              {status === "success" && (
                <p style={{ color: "green" }}>Thanks! Check your email soon.</p>
              )}
              {status === "error" && (
                <p style={{ color: "red" }}>
              ...
              {!(status === "error" || status === "success") && (
                <p>
                  I will immediately email you a <b>special key</b> to get your
                  game started & start juicing.
                </p>
              )}
            </>
          ) : (
            ...
            >
              {tokenStatus === "success" ? (
                ...
                <p style={{ color: "red" }}>
                  Error reading the key file. Please try again.
                </p>
              ) : (
                <p style={{ textAlign: "center" }}>
                  Drag and drop your special key file here
                  <br />
                  <input
                    type="file"
                    ref={fileInputRef}
